...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, PrinterIcon, Share2Icon, Sparkles, User } from 'lucide-react'
...
const ResumeBuilder = () => {
  ...
  const saveResume = async () => {
    try {
      ...
      // Check if image is a File object BEFORE deleting
      const imageFile = updatedResumeData.personal_info.image
      const isFileObject = imageFile instanceof File

      // Remove image from resumeData before sending
      if(isFileObject) {
      ...
      // Append the file we saved earlier
      if(isFileObject) {
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <hr className='absolute top-0 left-0 h-1 bg-gradient-to-r from-teal-500 to-teal-600 border-none
              ...
              <button onClick={() => {toast.promise(saveResume, {loading: "Saving..."})}} className='bg-gradient-to-br from-teal-100 to-teal-200 rint-teal-00 
              text-green-600 ring hover:ring-teal-400 transition-all rounded-md 
                  ...
                  <div className='absolute bottom-3 right-0 left-0 flex items-center justify-end gap-2'>
                    {
                      resumeData.public && (
                        ...
                        from-teal-100 to-teal-200 text-teal-600 rounded-lg ring-teal-300 
                    ...
                    <button onClick={printResume} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br 
                        from-teal-100 to-teal-200 text-teal-600 rounded-lg ring-teal-300 
                        hover:ring transition-colors'>
