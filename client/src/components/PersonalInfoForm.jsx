            ...
            <label>
                {
                    data.image ? (
                        ...
                        alt="User image" className='w-16 h-16 rounded-full object-cover mt-5 ring 
                ...
                <input type="file" accept='imge/jpeg, image/png' className='hidden' 
                ...
                typeof data.image === 'object' && (
                    <div className='flex flex-col gap-1 pl-4 text-sm'>
                        ...
                        text-gray-900 gap-3'>
                            ...
                            <div className='w-9 h-5 bg-slate-300 rounded-full peer peer-checked:bg-teal-600 
            ...
            fields.map((field) => {
                ...
                return (
                    <div key={field.key} className='space-y-1 mt-5'>
                        ...
                        focus:ring-teal-500 focus:border-teal-500 outline-none transition-colors text-sm' 
