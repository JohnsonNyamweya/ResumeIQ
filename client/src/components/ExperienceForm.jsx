...
const ExperienceForm = ({data, onChange}) => {
    ...
    const generateDescription = async (index) => {
        ...
        try {
            const {data} = await api.post('/api/openai/enhance-job-desc', {userContent: prompt}, {headers: {Authorization: token}})
  ...
  return (
    <div className='space-y-6'>
        ...
        <div className='flex items-center justify-between'>
            ...
            <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm bg-teal-100 
            text-teal-700 rounded hover:bg-teal-200 transition-colors'>
                            ...
                            <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                                ...
                                <div className='space-y-2'>
                                    <div className='flex items-center justify-between'>
                                        ...
                                        text-sm bg-teal-100 text-teal-700 rounded hover:bg-teal-200 
