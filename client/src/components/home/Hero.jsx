      ...
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          <a href="https://prebuiltui.com">
            <img className="h-11 w-auto " src="/logo.svg" alt="ResumeIQ logo" />
          </a>

          <div className="hidden md:flex items-center gap-8 transition duration-500 text-black-800">
            <a href="#" className="hover:text-cyan-600 transition">
              Home
            </a>
            <a href="#features" className="hover:text-cyan-600 transition">
              Features
            </a>
            <a
              href="#testimonials"
          ...
          <div className="flex gap-2">
            <Link
              ...
              className={`${user ? 'hidden' : 'hidden md:block'} px-6 py-2 bg-cyan-500 hover:bg-cyan-700 active:scale-95 transition-all rounded-full text-white`}
              hidden={user}
            >
              Get started
            </Link>
            <Link
              to="/app?state=login"
              className={`${user ? 'hidden' : 'hidden md:block'} px-6 py-2 border active:scale-95 hover:bg-slate-50 transition-all rounded-full text-slate-700 hover:text-slate-900`}
              hidden={user}
            >
              Login
            </Link>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
            ...
            <span className=" bg-gradient-to-r from-teal-700 to-teal-600 bg-clip-text text-transparent text-nowrap">
              AI powered{" "}
            </span>{" "}
            Resume.
          </h1>
          ...
          <div className="flex items-center gap-4 ">
            <Link
              to="/app"
              className="bg-teal-500 hover:bg-teal-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-teal-400 flex items-center transition-colors"
            >
              Get started
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button className="flex items-center gap-2 border border-teal-400 hover:bg-teal-50 transition rounded-full px-7 h-12 text-slate-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
